...
<?php if (!empty($installations)):?>
 ...
 <section class="module module--products border-t border-b border-black/10">
    <div class="container mx-auto h-full px-4 lg:px-0">
        <div class="py-14">
            <div class="mb-10">
                <h2 class="text-3xl font-400 w-5/12 mb-1">Our Recent Mosquito Net for UPVC Windows & Doors</h2>
                <p class="w-9/12 font-quicksand text-gray font-bold">We have successfully satisfied consumers on basis for wide variety of mosquito nets for windows and doors.</p>
            </div>
