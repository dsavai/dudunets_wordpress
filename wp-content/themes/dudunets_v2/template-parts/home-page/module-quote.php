                ...
                <form id="front_page_quote_form" method="post">
                    <div class="block lg:flex lg:gap-6 items-center w-full">
                        <div class="relative mb-2 lg:mb-0">
                            ...
                            <input name="full_name" id="fs-name" type="text" placeholder="Enter your full names" class="w-full lg:w-[300px] h-[52px] font-medium bg-black/5 placeholder:text-black/70 py-2 px-5 text-sm" />
                        </div>
                        <div class="relative mb-2 lg:mb-0">
