                ...
                <form id="front_page_quote_form" method="post">
                    <div class="flex gap-6 items-center">
                        <div>
                            ...
                            <input name="full_name" id="fs-name" type="text" placeholder="Enter your full names" class="w-[300px] h-[45px] border-[1px] border-secondary/10 py-2 px-5 rounded-lg text-sm" />
                        </div>
                        <div>
                            <label for="phone-number"class="block text-sm font-semibold mb-1">Phone number<span class="text-red">*</span></label>
                            <input name="mobile" id="phone-number" type="text" placeholder="Enter your phone number" class="w-[300px] h-[45px] border-[1px] border-secondary/10 py-2 px-5 rounded-lg text-sm" />
                        </div>
                        <div>
                            <label for="email"class="block text-sm font-semibold mb-1">Email<span class="text-red">*</span></label>
                            <input name="email" id="email" type="text" placeholder="Enter your email" class="w-[300px] h-[45px] border-[1px] border-secondary/10 py-2 px-5 rounded-lg text-sm" />
                        </div>
                        <div>
                            <label for="location"class="block text-sm font-semibold mb-1">Location<span class="text-red">*</span></label>
                            <input name="location" id="location" type="text" placeholder="Enter your location" class="h-[45px] border-[1px] border-secondary/10 py-2 px-5 rounded-lg text-sm" />
                        </div>
