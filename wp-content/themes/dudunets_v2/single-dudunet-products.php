            ...
            <div class="container m-auto">
                <div class="container-product mt-10 px-4 lg:px-0">
                    <div class="section-about mb-10 border-b pb-5 border-black/10">
                        <div>
                            <h2 class="text-2xl font-bold"><?php echo $the_page->post_excerpt?></h2>
                            <p class="text-black/60 font-normal leading-relaxed"><?php echo get_post_meta($the_page->ID, 'custom_excerpt', true);?></p>
                        </div>
                        <div class="mt-3">
