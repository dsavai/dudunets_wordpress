    ...
    <div class="container mx-auto">
        ...
        <div class="section--videos mt-16">
            ...
            <div class="grid grid-cols-3 gap-x-4 gap-y-10">
                <div>
                    <a href="https://www.youtube.com/embed/ZXjHqf9oCFU?si=-z5Ns4Zw5MAeiAsj" data-fancybox-type="iframe" class="fancy_youtube fancybox iframe relative cursor-pointer block">
                        <div class="w-full h-[240px] overflow-hidden relative">
                            <img src="https://picsum.photos/600/600" alt="" class="object-cover w-full h-full" />
                        ...
                        <div class="mt-5">
                            ...
                            <div class="text-sm text-gray font-semibold">October 20, 2024</div>
                        </div>
                    </a>
                </div>
                <div>
