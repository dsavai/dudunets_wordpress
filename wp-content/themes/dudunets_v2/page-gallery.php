...
$allPhotos = get_posts_by_taxonomy("showcases","inspiration_type","photo","-1");
$gallery_page =  get_page_by_slug("gallery");
...
<main id="mainMain" class="module">
    <div class="container mx-auto px-4 lg:px-0 pt-8 pb-8 lg:pt-8 lg:pb-14">
        <div class="lg:my-8">
            <h2 class="mb-2 text-3xl font-400"><?php $gallery_page->post_excerpt?></h2>
            <p class="text-black/60 font-medium leading-relaxed"><?php $gallery_page->post_content?></p>
        </div>
